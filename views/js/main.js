...
var resizePizzas = function(size) {
 ...
 function changePizzaSizes(size) {
  ...
  // Only need to reference one instance of the randomPizzaContainers array to calculate dx and newWidth
...
// Optimized by use of element lookup.
  ...
  for (var i= 0; i <5; i++) {
  phaseArray.push(Math.sin(location + i));
  // Un-comment to see array values
  //console.log("Phase Array:" + phaseArray);
  }
